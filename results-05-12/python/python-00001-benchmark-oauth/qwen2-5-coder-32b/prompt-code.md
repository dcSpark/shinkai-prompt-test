...
<input_command>
Generate a tool that creates a event in Google Calendar. All OAuth variables should be set in the config. given type INPUT = { event: string, description: string, start_iso: string, end_iso: string }
