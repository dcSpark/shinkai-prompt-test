...
<input_command>
Generate a tool that downloads a website, converts their HTML content to Markdown and finally return the Markdown content as { content: string }. given type INPUT = { urls: string[] }
